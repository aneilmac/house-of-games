...
def __altrange(c):
    ...
    "ACDEFGHIJKLMNOPRQRSTUVWXYZ". This function respects the case of the passed character.
    If given a non-alpha character returns an empty iterator.
    """
    ...
    if not c.isalpha():
        ...
        return map(chr, itertools.chain(range(ord(c1), ord(c)),
...
def mouse_of_games(line, spell_checker):
    """
    Takes a string and spell checker, generates all "Mouse of Game" 
